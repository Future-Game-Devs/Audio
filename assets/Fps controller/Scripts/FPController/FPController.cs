...
namespace FPControllerspace
{
    ...
    public class FPController : MonoBehaviour
    {
        ...
        private void Updateclimbing()
        {
           ...
           Vector3 _climbingVelocity = desiredDirection * _climbingspeed * Time.deltaTime;
            _controller.Move(_climbingVelocity);
        ...
        private void Updateslidingladder()
        {
            Vector3 _slidingVelocity = Vector2.down * 8 * Time.deltaTime;
            _controller.Move(_slidingVelocity);
            if (IsGrounded)
            {
